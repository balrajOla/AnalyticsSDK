...
public enum TrackerGender: String {
    case male = "Male"
    case female = "Female"
...
open class TrackerUserProfile: NSObject {
    ...
    /// The gender of the user as a `TrackerGender`.
    open var gender: TrackerGender?
